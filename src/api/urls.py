...
from api.views import UserApiViewModelSet, ReceiveSubmissionResults, ReceiveStaticAnalysisResults
...
urlpatterns = [
    ...
    *classroom_urls,
    ...
    path("submission_static_analysis/<int:submission_id>/", ReceiveStaticAnalysisResults.as_view()),
